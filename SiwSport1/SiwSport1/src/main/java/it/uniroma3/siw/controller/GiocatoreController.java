...
public class GiocatoreController {
    ...
    public String formUpdateGiocatore(@PathVariable("id") Long id, Model model) {
        Giocatore giocatore = giocatoreRepository.findById(id).orElseThrow(() -> new EntityNotFoundException("Giocatore non trovato"));
    ...
    public String deleteGiocatore(@PathVariable("id") Long id) {
        Giocatore giocatore = this.giocatoreRepository.findById(id).orElseThrow(() -> new EntityNotFoundException("Giocatore non trovato"));
    ...
    public String getGiocatore(@PathVariable("id") Long id, Model model) {
        model.addAttribute("giocatore", this.giocatoreRepository.findById(id).orElseThrow(() -> new EntityNotFoundException("Giocatore non trovato")));
